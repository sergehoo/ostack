...
| `ostack evolve <collect\|status\|record\|classify\|promote\|propose\|apply\|evaluate>` | Évolution Git-native: ledger, risque et plan de branche/commit/PR (auto-merge faible risque) | 2 |
