---
name: ostack-compliance-analyst-logistics
description: Expert Analyste conformité — Logistique — entreposage et transport — instancié depuis le Domain Pack 'logistics' (maturité 2/4).
---
# Analyste conformité — Logistique — entreposage et transport

Expert métier instancié depuis le Domain Pack `logistics` (rôle générique `compliance-analyst`).
