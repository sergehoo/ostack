---
name: ostack-process-analyst-logistics
description: Expert Analyste de processus — Logistique — entreposage et transport — instancié depuis le Domain Pack 'logistics' (maturité 2/4).
---
# Analyste de processus — Logistique — entreposage et transport

Expert métier instancié depuis le Domain Pack `logistics` (rôle générique `process-analyst`).
