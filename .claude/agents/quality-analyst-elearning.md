---
name: ostack-quality-analyst-elearning
description: Expert Analyste qualité — E-learning — formation et apprentissage en ligne — instancié depuis le Domain Pack 'elearning' (maturité 2/4).
---
# Analyste qualité — E-learning — formation et apprentissage en ligne

Expert métier instancié depuis le Domain Pack `elearning` (rôle générique `quality-analyst`).
