---
name: ostack-operations-analyst-logistics
description: Expert Analyste des opérations — Logistique — entreposage et transport — instancié depuis le Domain Pack 'logistics' (maturité 2/4).
---
# Analyste des opérations — Logistique — entreposage et transport

Expert métier instancié depuis le Domain Pack `logistics` (rôle générique `operations-analyst`).
