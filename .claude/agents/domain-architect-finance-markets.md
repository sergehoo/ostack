---
name: ostack-domain-architect-finance-markets
description: Expert Architecte de domaine — Finance — marchés, trading, gestion de portefeuille, investissement — instancié depuis le Domain Pack 'finance-markets' (maturité 2/4).
---
# Architecte de domaine — Finance — marchés, trading, gestion de portefeuille, investissement

Expert métier instancié depuis le Domain Pack `finance-markets` (rôle générique `domain-architect`).
