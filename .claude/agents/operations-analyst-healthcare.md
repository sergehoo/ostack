---
name: ostack-operations-analyst-healthcare
description: Expert Analyste des opérations — Santé — parcours patient et établissement de soins — instancié depuis le Domain Pack 'healthcare' (maturité 2/4).
---
# Analyste des opérations — Santé — parcours patient et établissement de soins

Expert métier instancié depuis le Domain Pack `healthcare` (rôle générique `operations-analyst`).
