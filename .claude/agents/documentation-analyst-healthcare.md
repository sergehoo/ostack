---
name: ostack-documentation-analyst-healthcare
description: Expert Analyste documentaire — Santé — parcours patient et établissement de soins — instancié depuis le Domain Pack 'healthcare' (maturité 2/4).
---
# Analyste documentaire — Santé — parcours patient et établissement de soins

Expert métier instancié depuis le Domain Pack `healthcare` (rôle générique `documentation-analyst`).
