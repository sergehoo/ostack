---
name: ostack-operations-analyst-elearning
description: Expert Analyste des opérations — E-learning — formation et apprentissage en ligne — instancié depuis le Domain Pack 'elearning' (maturité 2/4).
---
# Analyste des opérations — E-learning — formation et apprentissage en ligne

Expert métier instancié depuis le Domain Pack `elearning` (rôle générique `operations-analyst`).
