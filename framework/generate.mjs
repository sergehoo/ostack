...
const COMMANDS = [
  ...
  ["security", "Auditer la sécurité de façon strictement défensive (Blue/Purple Team).",
    ...
    "review | dependencies | threat-model <système> | catalog [niveau] | permissions <f.json> | containers | evidence <f.json> | retest <f.json>"],
  ["incident", "Structurer une réponse à incident de sécurité (défensif).",
    ...
    "<intitulé de l'incident> | <fichier.json>"]
];
